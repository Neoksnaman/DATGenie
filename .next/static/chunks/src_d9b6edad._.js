...
"[project]/src/lib/data:0f559c [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$0f559c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:0f559c [app-client] (ecmascript) <text/javascript>");
        ...
        "TaxProfileProvider.useCallback[fetchProfiles]": (isManualRefresh = false)=>{
            ...
            startTransition({
                "TaxProfileProvider.useCallback[fetchProfiles]": async ()=>{
                    ...
                    if (databaseId) {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$0f559c__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getUserHeaderData"])(databaseId);
...
"[project]/src/lib/data:322075 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$322075__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:322075 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
'use client';
...
const DatFilesProvider = ({ children })=>{
    ...
    const [isPending, startTransition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"])();
    const initialFetchComplete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const fetchFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DatFilesProvider.useCallback[fetchFiles]": async (isManualRefresh = false)=>{
            if (isPending) return;
            startTransition({
                "DatFilesProvider.useCallback[fetchFiles]": async ()=>{
                    const folderId = localStorage.getItem('folderId');
                    if (folderId) {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$322075__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getDatFiles"])(folderId);
                        if (result.success && result.files) {
                            ...
                            if (isManualRefresh) {
                                ...
                                // Also notify other tabs when a manual refresh is done
    ...
    // Effect to set up and tear down the broadcast channel
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            ...
            const handleMessage = {
                "DatFilesProvider.useEffect.handleMessage": (event)=>{
                    if (event.data === 'refresh') {
                        console.log('DAT file refresh message received from another tab.');
                        fetchFiles(false); // Fetch without showing toast
                    }
                }
    ...
    const addOrUpdateFile = (file)=>{
        ...
        // After a delay to allow Drive to process, tell other tabs to refresh
        setTimeout(()=>{
            channelRef.current?.postMessage('refresh');
        }, 3000);
    };
    const removeFile = (fileId)=>{
        ...
        // Tell other tabs that a file was removed
        setTimeout(()=>{
            channelRef.current?.postMessage('refresh');
        }, 3000);
    };
...
_s(DatFilesProvider, "8SB48PehK56YX/3yyPxleliQ+Vo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"]
    ];
...
function AppLayoutContent({ children }) {
    ...
    const { fetchProfiles, initialFetchComplete: taxProfilesFetched } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$tax$2d$profiles$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTaxProfiles"])();
    const { fetchFiles, initialFetchComplete: datFilesFetched } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$dat$2d$files$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDatFiles"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppLayoutContent.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                const databaseId = localStorage.getItem('databaseId');
                const folderId = localStorage.getItem('folderId');
                if (databaseId && !taxProfilesFetched) {
                    fetchProfiles();
                }
                if (folderId && !datFilesFetched) {
                    fetchFiles();
                }
            }
        }
...
_s(AppLayoutContent, "6nyKy9GmLDe8NLXOPO1hyOZl1xs=", false, function() {
    return [
...
//# sourceMappingURL=src_d9b6edad._.js.map