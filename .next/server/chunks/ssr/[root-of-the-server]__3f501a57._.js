...
"[project]/src/lib/data:7a9174 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$7a9174__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:7a9174 [app-ssr] (ecmascript) <text/javascript>");
...
function LoginPage() {
    ...
    const onSubmit = (data)=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$7a9174__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["loginUser"])(data);
            if (result.success && result.databaseId) {
                // Store the databaseId in sessionStorage
                sessionStorage.setItem('databaseId', result.databaseId);
                toast({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f501a57._.js.map