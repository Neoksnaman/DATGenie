...
async function getGmailClient() {
    const oauth2Client = await getOAuth2Client();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$googleapis$2f$build$2f$src$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["google"].gmail({
        version: 'v1',
        auth: oauth2Client
    });
}
...
{
__turbopack_context__.s({
    "addPendingVerification": (()=>addPendingVerification),
    ...
    "deletePendingVerification": (()=>deletePendingVerification),
    "deleteSessionByToken": (()=>deleteSessionByToken),
    "findAndVerifyPendingToken": (()=>findAndVerifyPendingToken),
    ...
    "updateUserFolderIdAndDbId": (()=>updateUserFolderIdAndDbId)
});
...
const signupSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    ...
    databaseId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string()
});
...
async function updateUserFolderIdAndDbId(userName, folderId, databaseId) {
    const sheets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSheetsClient"])();
    ...
    const userNameIndex = header.indexOf('userName');
    const folderIdIndex = header.indexOf('folderID');
    const dbIdIndex = header.indexOf('databaseID');
    if (userNameIndex === -1 || folderIdIndex === -1 || dbIdIndex === -1) {
        throw new Error('userName, folderID, or databaseID column not found.');
    }
    ...
    await sheets.spreadsheets.values.update({
        spreadsheetId: SPREADSHEET_ID,
        range: `${CREDENTIALS_SHEET_NAME}!${String.fromCharCode('A'.charCodeAt(0) + folderIdIndex)}${rowToUpdate}`,
    ...
    await sheets.spreadsheets.values.update({
        spreadsheetId: SPREADSHEET_ID,
        range: `${CREDENTIALS_SHEET_NAME}!${String.fromCharCode('A'.charCodeAt(0) + dbIdIndex)}${rowToUpdate}`,
        valueInputOption: 'RAW',
        resource: {
            values: [
                [
...
async function findRowIndexByToken(token, sheetName) {
    const sheets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSheetsClient"])();
    const response = await sheets.spreadsheets.values.get({
        spreadsheetId: SPREADSHEET_ID,
        range: `${sheetName}!A:E`
    ...
    const rowIndex = rows.findIndex((row)=>row[tokenIndex] === token);
...
async function deleteSessionByToken(token) {
    const { sheetId, rowIndex } = await findRowIndexByToken(token, SESSIONS_SHEET_NAME);
    const sheets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSheetsClient"])();
    await sheets.spreadsheets.batchUpdate({
        spreadsheetId: SPREADSHEET_ID,
        resource: {
...
async function addPendingVerification(data) {
    const sheets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSheetsClient"])();
    const sheetName = PENDING_VERIFICATIONS_SHEET_NAME;
    // First, find and delete any existing verification for the same email
    const getResponse = await sheets.spreadsheets.values.get({
        spreadsheetId: SPREADSHEET_ID,
        range: `${sheetName}!A:E`
    });
    ...
    if (rows && rows.length > 1) {
        ...
        const existingRowIndex = rows.findIndex((row, index)=>index > 0 && row[emailIndex] === data.email);
        if (existingRowIndex !== -1) {
            console.log(`[Verification] Found existing pending verification for ${data.email}. Removing before adding new one.`);
            const sheetId = await getSheetId(SPREADSHEET_ID, sheetName);
            if (sheetId === null) {
                throw new Error(`Sheet with name "${sheetName}" not found.`);
            }
    ...
    // Now, append the new verification
    const values = [
        [
            data.email,
            data.userName,
    ...
    try {
        await sheets.spreadsheets.values.append(appendRequest);
        console.log(`[Verification] Added new pending verification for ${data.email}`);
    } catch (err) {
        console.error('The API returned an error while adding a pending verification: ' + err);
        throw new Error('Failed to add pending verification to Google Sheet.');
    }
}
async function findAndVerifyPendingToken(token) {
    const sheets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSheetsClient"])();
    const response = await sheets.spreadsheets.values.get({
        spreadsheetId: SPREADSHEET_ID,
    ...
    const pendingRow = rows.slice(1).find((row)=>row[tokenIndex] === token);
    if (!pendingRow) return null;
    const expirationDate = new Date(pendingRow[expirationIndex]);
    if (expirationDate < new Date()) {
        // Token has expired, we should probably delete it
        await deletePendingVerification(token);
        return null;
    }
    return {
        email: pendingRow[emailIndex],
        userName: pendingRow[userNameIndex],
        password: pendingRow[passwordIndex]
    };
}
async function deletePendingVerification(token) {
    const { sheetId, rowIndex } = await findRowIndexByToken(token, PENDING_VERIFICATIONS_SHEET_NAME);
    const sheets = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSheetsClient"])();
    await sheets.spreadsheets.batchUpdate({
        spreadsheetId: SPREADSHEET_ID,
        resource: {
...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"00186ae8b46ba208c20a4a809212c1f3e6948fe1b2":"getInitialPageTokenForDrive","40b059e63060f3f4feea26611d7aec8c3ec0ede92f":"downloadFileFromDrive","40dd2f09e524554b4ec3a9fff80a021fad2531abc0":"listDatFiles","40eb3992284d3f345830502ed25bef9bf64111ffac":"deleteFileFromDrive","600db5225566d190dce92c616480c03104d3ffae89":"createSpreadsheetInFolder","6019d8efc0e8739c514bfb3847f6eef6107aca4d72":"createFolderInDrive","60f30c24add5ece81b8a4e4f22fb29dca30abc29de":"listChangesSincePageToken","70864395bb092dc39044827f4dcf80a5be65f97fdf":"checkFileExists","7cada598f594d88c11337b2248ef7320b7b540f236":"uploadFileToDrive"},"",""] */ __turbopack_context__.s({
    "checkFileExists": (()=>checkFileExists),
    "createFolderInDrive": (()=>createFolderInDrive),
    "createSpreadsheetInFolder": (()=>createSpreadsheetInFolder),
...
async function createFolderInDrive(name, parentId) {
    ...
    try {
        ...
        console.log(`[Drive] Created folder "${name}" with ID: ${file.data.id}`);
        return file.data;
    } catch (error) {
        console.error(`[Drive] Error creating folder "${name}":`, error);
        throw error;
    }
}
async function createSpreadsheetInFolder(fileName, folderId) {
    const drive = await getDriveClient();
    ...
    try {
        ...
        // Move the spreadsheet to the desired folder
        ...
        const initialSheet = (await sheets.spreadsheets.get({
            spreadsheetId,
            fields: 'sheets.properties'
        })).data.sheets?.find((s)=>s.properties?.sheetId === 0);
        if (initialSheet) {
            await sheets.spreadsheets.batchUpdate({
                spreadsheetId,
                resource: {
                    requests: [
                        {
                            deleteSheet: {
                                sheetId: initialSheet.properties?.sheetId
                            }
                        }
                    ]
                }
        ...
        console.log(`[Drive/Sheets] Created and configured spreadsheet "${fileName}" with ID: ${spreadsheetId}`);
        return {
            id: spreadsheetId,
            name: fileName
        };
    } catch (error) {
        console.error(`[Drive] Error creating spreadsheet "${fileName}":`, error);
        throw error;
    }
}
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createFolderInDrive, "6019d8efc0e8739c514bfb3847f6eef6107aca4d72", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createSpreadsheetInFolder, "600db5225566d190dce92c616480c03104d3ffae89", null);
...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"60560c40f4d2cc065f1d58a4b24cac873fa71403bb":"sendVerificationEmail"},"",""] */ __turbopack_context__.s({
...
async function sendVerificationEmail(to, verificationUrl) {
    const gmail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getGmailClient"])();
    const subject = 'Verify Your DATGenie Account';
    const utf8Subject = `=?utf-8?B?${Buffer.from(subject).toString('base64')}?=`;
    const messageParts = [
        `From: DATGenie <noreply@datgenie.com>`,
        `To: ${to}`,
        'Content-Type: text/html; charset=utf-8',
        'MIME-Version: 1.0',
        `Subject: ${utf8Subject}`,
        '',
        '<h1>Welcome to DATGenie!</h1>',
        `<p>Please click the link below to verify your email address and complete your registration. This link will expire in one hour.</p>`,
        `<p><a href="${verificationUrl}">Verify My Account</a></p>`,
        '<p>If you did not sign up for a DATGenie account, you can safely ignore this email.</p>'
    ];
...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"0077798b1627f8549856e5ef771e5b5197af078b59":"logoutUser","4042067a83252849717e7a5b3e62744a492bf4012c":"loginUser","40ae828c6e9f5db562a01c76329ee06eccca978d8b":"verifyUserAccount","40c6312d939e0f94e11390cab80586edc945c86980":"signUpUser"},"",""] */ __turbopack_context__.s({
    "loginUser": (()=>loginUser),
...
async function signUpUser(userData) {
    try {
        ...
        // 1. Check if user already exists in credentials or pending
        const existingUsers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllUsers"])();
        if (existingUsers.some((u)=>u.userName === userName || u.emailAddress === email)) {
            return {
                success: false,
        ...
        // This part would ideally also check the pending verifications sheet
        // For simplicity in this step, we'll rely on the DB constraint/check.
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addPendingVerification"])({
            ...userData,
            token,
            expiration: expiration.toISOString()
        });
        // 4. Send verification email
        const verificationUrl = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["headers"])().get('origin')}/verify?token=${token}`;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendVerificationEmail"])(email, verificationUrl);
        return {
            success: true,
            error: null,
            user: null
...
async function verifyUserAccount(token) {
    try {
        const pendingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findAndVerifyPendingToken"])(token);
        if (!pendingUser) {
            return {
                success: false,
        ...
        const accountsFolderId = process.env.GOOGLE_DRIVE_ACCOUNTS_FOLDER_ID;
        if (!accountsFolderId) throw new Error('Root accounts folder ID is not configured.');
        // Create user folder
        const userFolder = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createFolderInDrive"])(pendingUser.email, accountsFolderId);
        // Create spreadsheet
        const spreadsheet = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createSpreadsheetInFolder"])(`Database - ${pendingUser.email}`, userFolder.id);
        // Finalize user by adding to credentials sheet
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["appendUserToSheet"])({
            ...
            databaseId: spreadsheet.spreadsheetId
        });
        // Clean up pending verification
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deletePendingVerification"])(token);
        return {
            success: true
        };
    } catch (e) {
        ...
        return {
            success: false,
            error: `Failed to verify account: ${errorMessage}`
        };
    }
}
async function loginUser(credentials) {
    try {
        ...
        if (user) {
            let { folderId, databaseId } = user;
            if (!folderId || !databaseId) {
                console.log(`User ${user.userName} is missing folder/database IDs. Recreating...`);
                const accountsFolderId = process.env.GOOGLE_DRIVE_ACCOUNTS_FOLDER_ID;
                if (!accountsFolderId) throw new Error('Root accounts folder ID is not configured.');
                const newFolder = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createFolderInDrive"])(user.emailAddress, accountsFolderId);
                const newSheet = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createSpreadsheetInFolder"])(`Database - ${user.emailAddress}`, newFolder.id);
                folderId = newFolder.id;
                databaseId = newSheet.spreadsheetId;
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateUserFolderIdAndDbId"])(user.userName, folderId, databaseId);
                console.log(`Successfully recreated and assigned resources for user ${user.userName}.`);
            }
            const sheetId = process.env.GOOGLE_SHEETS_SHEET_ID;
            if (!sheetId) {
                return {
                    success: false,
                    error: 'Google Sheet ID is not configured in the environment.',
                    user: null
                };
            }
            if (user.databaseId) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllHeaderDataFromSheet"])(user.databaseId);
                } catch (sheetError) {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(signUpUser, "40c6312d939e0f94e11390cab80586edc945c86980", null);
...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"607a7966fdc9879421faf80de95fe825bf872d679c":"processExcelFile"},"",""] */ __turbopack_context__.s({
...
"[project]/src/lib/dat-utils.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function sanitizeAndValidateString(input, fieldName, maxLength, isRequired = false, errorPrefix) {
    ...
    if (!value) {
        if (isRequired) {
            return {
                value: '',
                error: `${fullFieldName} is missing.`
            };
        }
        return {
            value: '',
    ...
    if (processedString.length > maxLength) {
        return {
            ...
            error: `${fullFieldName} must be ${maxLength} characters or less.`
        };
    }
    return {
        value: processedString,
...
function sanitizeAndValidateNumber(input, fieldName) {
    ...
    if (isNaN(num)) {
        return {
            value: String(input),
            error: `${fieldName} contains an invalid number.`
        };
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dat-utils.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-validate.js [app-rsc] (ecmascript)");
;
;
;
...
async function generateSalesDatFile(file, profile, month, year, folderId, overwrite = false) {
    ...
    const processedData = dataRows.map((row, index)=>{
        ...
        nameFieldsInfo.forEach((field)=>{
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sanitizeAndValidateString"])(processedRow[field.index], field.name, field.maxLength, field.required, errorPrefix);
        ...
        numericFields.forEach((field)=>{
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sanitizeAndValidateNumber"])(processedRow[field.index], `${errorPrefix}: ${field.name}`);
            if (result.error) validationErrors.push(result.error);
            processedRow[field.index] = result.value;
        });
    ...
    const lastDayDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getFormattedLastDay"])(parseInt(year), parseInt(month));
    const address1 = [
        profile.subStreet,
        profile.street,
        profile.barangay
    ...
    const detailRows = processedData.map((row)=>[
            'D',
            'S',
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(row[0]),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(row[1]),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(row[2]),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(row[3]),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(row[4]),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(row[5]),
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(row[6]),
            row[7],
            row[8],
            row[9],
            row[10],
    ...
    const headerRow = [
        'H',
        'S',
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(tin),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(profile.companyName),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(profile.lastName),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(profile.firstName),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(profile.middleName),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(profile.tradeName),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(address1),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(address2),
...
async function generate1601EQDatFile(file, profile, month, year, folderId, overwrite = false) {
    ...
    const processedSched1Data = sched1DataRows.filter((row)=>row.some((cell)=>String(cell).trim() !== '')).map((row, index)=>{
        ...
        numericFields.forEach((field)=>{
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sanitizeAndValidateNumber"])(processedRow[field.index], field.name, errorPrefix);
            if (result.error) validationErrors.push(result.error);
            processedRow[field.index] = result.value;
        });
    ...
    const processedSched2Data = sched2DataRows.filter((row)=>row.some((cell)=>String(cell).trim() !== '')).map((row, index)=>{
        ...
        const atc = String(processedRow[6] || '').toUpperCase().replace(/[^A-Z0-9]/g, '');
        processedRow[6] = atc;
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sanitizeAndValidateNumber"])(processedRow[7], 'Income Payment', errorPrefix);
        if (result.error) validationErrors.push(result.error);
    ...
    const mainHeader = [
        ...
        profile.tpTIN,
        profile.branchCode,
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["quoteIfNotEmpty"])(taxpayerName),
        reportingPeriod,
        profile.rdoCode
    ].join(',');
...
async function generate1601FQDatFile(file, profile, month, year, folderId, overwrite = false) {
    ...
    // Process schedule 2
    const { data: sched2DataRows, validationErrors: sched2FileErrors } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$common$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["processExcelFile"])(file, "1601FQ_sched2");
    if (sched2FileErrors.length > 0) return {
        ...defaultErrorResult,
        errors: sched2FileErrors
    };
    // Process schedule 3
    const { data: sched3DataRows, validationErrors: sched3FileErrors } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$common$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["processExcelFile"])(file, "1601FQ_sched3");
    if (sched3FileErrors.length > 0) return {
        ...defaultErrorResult,
        errors: sched3FileErrors
    };
    const sched1HasData = sched1DataRows.some((row)=>row.some((cell)=>String(cell).trim() !== ''));
    const sched2HasData = sched2DataRows.some((row)=>row.some((cell)=>String(cell).trim() !== ''));
    ...
    if (!sched1HasData && !sched2HasData && !sched3HasData) {
        return {
            ...defaultErrorResult,
            errors: [
                "No data found in 1601FQ_sched1, 1601FQ_sched2 or 1601FQ_sched3 sheets."
            ]
        };
    }
    const validationErrors = [];
    ...
    const processedSched1Data = sched1DataRows.filter((row)=>row.some((cell)=>String(cell).trim() !== '')).map((row, index)=>{
        ...
        const tinResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sanitizeAndValidateString"])(processedRow[0], 'TIN', 9, true, errorPrefix);
    ...
    // Process Schedule 3
    const processedSched3Data = sched3DataRows.filter((row)=>row.some((cell)=>String(cell).trim() !== '')).map((row, index)=>{
        const originalRowNumber = index + 2;
        ...
        processedRow[7] = atc;
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dat$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sanitizeAndValidateNumber"])(processedRow[8], 'Income Payment', errorPrefix);
        if (result.error) validationErrors.push(result.error);
    ...
    if (processedSched1Data.length > 0) {
        ...
        const footerRow = [
            ...
            branchCode,
            reportingPeriod,
            totalTaxableIncomePaymentSched1.toFixed(2),
            totalWithholdingTaxSched1.toFixed(2)
        ].join(',');
    ...
    if (processedSched2Data.length > 0) {
        ...
        const footerRow = [
            ...
            branchCode,
            reportingPeriod,
            totalFringeBenefit.toFixed(2),
            totalGrossedUp.toFixed(2),
            totalWithholdingTaxSched2.toFixed(2)
        ].join(',');
        datContentParts.push(footerRow);
    }
    // Schedule 3
    ...
    if (processedSched3Data.length > 0) {
        ...
        const footerRow = [
            ...
            branchCode,
            reportingPeriod,
            totalIncomePaymentSched3.toFixed(2)
        ].join(',');
        datContentParts.push(footerRow);
    }
    const datContent = datContentParts.join('\n');
...
async function overwriteDatFile(formData) {
    ...
    try {
        ...
        if (reportType === "1601-FQ (Schedule 1, 2, and 3)") {
            ...
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$1601fq$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generate1601FQDatFile"])(file, profile, month, year, folderId, true);
        }
        if (reportType === "Summary Alphalist of Withholding Tax (SAWT)") {
...
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/actions/profiles.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/lib/actions/drive.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/lib/actions/dat/main.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/lib/actions/dat/purchases.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/actions/profiles.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/lib/actions/drive.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/lib/actions/dat/main.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/lib/actions/dat/purchases.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$main$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions/dat/main.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$purchases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions/dat/purchases.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$profiles$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$main$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$purchases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions/auth.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/lib/actions/profiles.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/src/lib/actions/drive.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/src/lib/actions/dat/main.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/src/lib/actions/dat/purchases.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/actions/profiles.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/lib/actions/drive.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/lib/actions/dat/main.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/lib/actions/dat/purchases.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "40ec90e33963869b9290334a9c5b5d388e94fad285": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$purchases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createPurchasesDatFile"]),
...
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions/auth.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/lib/actions/profiles.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/lib/actions/drive.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/lib/actions/dat/main.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/src/lib/actions/dat/purchases.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "0077798b1627f8549856e5ef771e5b5197af078b59": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$profiles$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$main$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$purchases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["0077798b1627f8549856e5ef771e5b5197af078b59"]),
    ...
    "40ec90e33963869b9290334a9c5b5d388e94fad285": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$profiles$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$main$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$purchases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["40ec90e33963869b9290334a9c5b5d388e94fad285"]),
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$profiles$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$drive$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$main$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2f$dat$2f$purchases$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions/auth.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/lib/actions/profiles.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/src/lib/actions/drive.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/src/lib/actions/dat/main.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/src/lib/actions/dat/purchases.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <exports>');
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b306a596._.js.map