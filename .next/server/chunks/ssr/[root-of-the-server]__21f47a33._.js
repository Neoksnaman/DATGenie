...
const TaxProfileProvider = ({ children })=>{
    ...
    const removeProfile = (tin)=>{
        ...
        // If the deleted profile was the selected one, clear the selection
...
const DatFilesProvider = ({ children })=>{
    ...
    const fetchFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (isManualRefresh = false, isBackground = false)=>{
        const performFetch = async ()=>{
            ...
            if (!folderId) {
                console.log('[DatFilesContext] No folderId, skipping fetch.');
        ...
        // Fix: Add a guard to ensure folderId exists before proceeding.
        // This is crucial for background polling that might run after logout.
        if (isBackground && "undefined" !== 'undefined' && !localStorage.getItem('folderId')) {
...
function AppLayoutContent({ children }) {
    ...
    const showLoadingPage = !taxProfilesFetched || !datFilesFetched;
    const handleRefresh = ()=>{
        if (refresh) {
            startTransition(()=>{
                refresh(true);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21f47a33._.js.map