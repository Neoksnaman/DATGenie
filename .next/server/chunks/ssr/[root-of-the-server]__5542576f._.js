...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"004e488cb590d92b17f50e64eabec0d1d9c61651e7":"getInitialPageToken","40098fdfbbb36170895d26f1c11d82363ee9a1b214":"signUpUser","401ce1a9d271208095f87042b1ec2b335fce067d9a":"overwriteDatFile","405640ada876955278e1ad2e9d85009c459c46777d":"validateExcelForPurchases","405c07508d183d72b5368850183fd267f67971612c":"createPurchasesDatFile","40684f4520a7c51a570d419ba1c98670ab6ba52b14":"loginUser","40895842e07ef2f9872e21c8c7ad22133d33c8c849":"convertExcelToDat","409ed581e5408379567ee59d482c53493c2b00bf41":"deleteDatFile","40b2e571cd0cb75ab827e90db3316b90dd461882f2":"getUserHeaderData","40e37ac9324786da7f1b62b630be8993e4441f6a02":"getDatFiles","40eadca5c4f32c710e73aff0bf3f9fa61fc3c2f4cb":"analyzeExcelFile","40f56ad56ebf97cdfae4d75ba1150348b241dd020b":"getDatFileContent","600d25a2a512748645b2ab9e08d882195aee5baea8":"deleteTaxProfile","6022a1cfb2375819dc72d679a8d0a356632f2c7471":"checkForDatFileChanges","6043bcb009bc6aa9b83327467834f75494fa1f00b7":"addTaxProfile","605c8531afa8c5f149e9f846d9ff37049c9c3aa0ef":"validateAndProcessSAWT","60c03a02cedce74d6fc9664d1879a50f2ea48706fa":"updateTaxProfile"},"",""] */ __turbopack_context__.s({
...
async function signUpUser(userData) {
    try {
        ...
        console.error('Error signing up user:', e1);
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred.';
        return {
            success: false,
...
async function loginUser(credentials) {
    try {
        ...
        if (user) {
            ...
            // Check if the databaseId in sheet is accessible
            if (user.databaseId) {
                try {
        ...
        console.error('Error logging in user:', e1);
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred.';
        return {
            success: false,
...
async function addTaxProfile(profileData, databaseId) {
    try {
        ...
        console.error('Error adding tax profile:', e1);
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred.';
        return {
            success: false,
...
async function updateTaxProfile(profileData, databaseId) {
    try {
        ...
        console.error('Error updating tax profile:', e1);
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred.';
        return {
            success: false,
...
async function deleteTaxProfile(tpTIN, databaseId) {
    try {
        ...
        console.error('Error deleting tax profile:', e1);
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred.';
        return {
            success: false,
...
async function generate1601EQDatFile(file, profile, month, year, folderId, overwrite = false) {
    ...
    const processedSched1Data = sched1DataRows.filter((row)=>row.some((cell)=>String(cell).trim() !== '')).map((row, index)=>{
        ...
        nameFieldsInfo.forEach((field)=>{
            const result = sanitizeAndValidateString(processedRow[field.index], `Schedule 1 ${field.name}`, field.maxLength, originalRowNumber, field.required);
            if (result.error) validationErrors.push(result.error);
            processedRow[field.index] = result.value;
        });
        ...
        numericFields.forEach((field)=>{
            const result = sanitizeAndValidateNumber(processedRow[field.index], `Schedule 1 ${field.name}`, originalRowNumber);
            if (result.error) validationErrors.push(result.error);
            processedRow[field.index] = result.value;
        });
        if (atc) {
    ...
    const processedSched2Data = sched2DataRows.filter((row)=>row.some((cell)=>String(cell).trim() !== '')).map((row, index)=>{
        ...
        nameFieldsInfo.forEach((field)=>{
            const result = sanitizeAndValidateString(processedRow[field.index], `Schedule 2 ${field.name}`, field.maxLength, originalRowNumber, field.required);
            if (result.error) validationErrors.push(result.error);
            processedRow[field.index] = result.value;
        });
        const atc = String(processedRow[6] || '').toUpperCase().replace(/[^A-Z0-9]/g, '');
        processedRow[6] = atc;
        const result = sanitizeAndValidateNumber(processedRow[7], `Schedule 2 Income Payment`, originalRowNumber);
        if (result.error) validationErrors.push(result.error);
...
async function convertExcelToDat(formData) {
    ...
    try {
        ...
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred during conversion.';
        console.error('[convertExcelToDat] CRITICAL ERROR:', e1);
        return {
            ...defaultErrorResult,
...
async function overwriteDatFile(formData) {
    ...
    try {
        ...
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred during overwrite.';
        console.error('[overwriteDatFile] CRITICAL ERROR:', e1);
        return {
            ...defaultErrorResult,
...
async function createPurchasesDatFile(formData) {
    ...
    try {
        ...
        const errorMessage = e1 instanceof Error ? e1.message : 'An unknown error occurred during DAT file creation.';
        console.error('[createPurchasesDatFile] CRITICAL ERROR:', e1);
        return {
            ...defaultErrorResult,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getDatFileContent, "40f56ad56ebf97cdfae4d75ba1150348b241dd020b", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteDatFile, "409ed581e5408379567ee59d482c53493c2b00bf41", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(validateAndProcessSAWT, "605c8531afa8c5f149e9f846d9ff37049c9c3aa0ef", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getInitialPageToken, "004e488cb590d92b17f50e64eabec0d1d9c61651e7", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(checkForDatFileChanges, "6022a1cfb2375819dc72d679a8d0a356632f2c7471", null);
}}),
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "004e488cb590d92b17f50e64eabec0d1d9c61651e7": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getInitialPageToken"]),
    "401ce1a9d271208095f87042b1ec2b335fce067d9a": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["overwriteDatFile"]),
    "405640ada876955278e1ad2e9d85009c459c46777d": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["validateExcelForPurchases"]),
    "405c07508d183d72b5368850183fd267f67971612c": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createPurchasesDatFile"]),
    "40895842e07ef2f9872e21c8c7ad22133d33c8c849": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["convertExcelToDat"]),
    "40b2e571cd0cb75ab827e90db3316b90dd461882f2": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUserHeaderData"]),
    "40e37ac9324786da7f1b62b630be8993e4441f6a02": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDatFiles"]),
    "6022a1cfb2375819dc72d679a8d0a356632f2c7471": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkForDatFileChanges"]),
    "6043bcb009bc6aa9b83327467834f75494fa1f00b7": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addTaxProfile"]),
    "60c03a02cedce74d6fc9664d1879a50f2ea48706fa": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateTaxProfile"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
"[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/lib/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "004e488cb590d92b17f50e64eabec0d1d9c61651e7": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["004e488cb590d92b17f50e64eabec0d1d9c61651e7"]),
    "401ce1a9d271208095f87042b1ec2b335fce067d9a": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["401ce1a9d271208095f87042b1ec2b335fce067d9a"]),
    "405640ada876955278e1ad2e9d85009c459c46777d": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["405640ada876955278e1ad2e9d85009c459c46777d"]),
    "405c07508d183d72b5368850183fd267f67971612c": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["405c07508d183d72b5368850183fd267f67971612c"]),
    "40895842e07ef2f9872e21c8c7ad22133d33c8c849": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["40895842e07ef2f9872e21c8c7ad22133d33c8c849"]),
    "40b2e571cd0cb75ab827e90db3316b90dd461882f2": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["40b2e571cd0cb75ab827e90db3316b90dd461882f2"]),
    "40e37ac9324786da7f1b62b630be8993e4441f6a02": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["40e37ac9324786da7f1b62b630be8993e4441f6a02"]),
    "6022a1cfb2375819dc72d679a8d0a356632f2c7471": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["6022a1cfb2375819dc72d679a8d0a356632f2c7471"]),
    "6043bcb009bc6aa9b83327467834f75494fa1f00b7": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["6043bcb009bc6aa9b83327467834f75494fa1f00b7"]),
    "60c03a02cedce74d6fc9664d1879a50f2ea48706fa": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["60c03a02cedce74d6fc9664d1879a50f2ea48706fa"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <module evaluation>');
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$home$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(app)/home/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <exports>');
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5542576f._.js.map