(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root-of-the-server]__cee7b85a._.js", {
...
"[project]/src/lib/drive.ts [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getDriveClient() {
    const oauth2Client = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2d$oauth$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getOAuth2Client"])();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$googleapis$2f$build$2f$src$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["google"].drive({
        version: 'v3',
        auth: oauth2Client
    });
}
    ...
    try {
        ...
        return new Promise((resolve, reject)=>{
            ...
            response.data.on('data', (chunk)=>buf.push(chunk)).on('end', ()=>{
                const content = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].concat(buf).toString();
                resolve(content);
            }).on('error', (err)=>{
...
"[project]/src/lib/actions [middleware-edge] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
__turbopack_context__.n(__import_unsupported(`crypto`));
}}),
"[project]/src/lib/actions/auth.ts [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/drive.ts [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/zod/lib/index.mjs [middleware-edge] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions [middleware-edge] (ecmascript)");
'use server';
;
;
;
;
;
const AuthResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].object({
    success: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].boolean(),
    error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].string().nullable(),
    user: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].object({
        userName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].string(),
        email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].string().optional(),
        databaseId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].string().optional(),
        folderId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].string().optional()
    }).nullable()
});
async function signUpUser(userData) {
    try {
        const folderId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createFolderInDrive"])(`DATGenie_${userData.userName}`);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["appendUserToSheet"])({
            ...userData,
            folderId
        });
        return {
...
async function loginUser(credentials) {
    try {
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getAllUsers"])();
        ...
        if (user) {
            ...
            if (!folderId) {
                ...
                folderId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$drive$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createFolderInDrive"])(`DATGenie_${user.userName}`);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["updateUserFolderId"])(user.userName, folderId);
            ...
            if (user.databaseId) {
                try {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getAllHeaderDataFromSheet"])(user.databaseId);
                } catch (sheetError) {
            ...
            const sessionToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["randomUUID"])();
            const headersList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$headers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["headers"])();
            const ipAddress = headersList.get('x-forwarded-for') || 'Unknown';
            const deviceInfo = headersList.get('user-agent') || 'Unknown';
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["addSessionToSheet"])({
                userName: user.userName,
                sessionToken,
                ipAddress,
                deviceInfo
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])().set('sessionToken', sessionToken, {
                httpOnly: true,
...
const LogoutResultSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].object({
    success: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["z"].boolean()
});
async function logoutUser() {
    const sessionToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])().get('sessionToken')?.value;
    if (sessionToken) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["deleteSessionByToken"])(sessionToken);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])().delete('sessionToken');
    }
    return {
        success: true
    };
...
async function findUserBySessionToken(token) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["findUserByTokenFromSheet"])(token);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions/auth.ts [middleware-edge] (ecmascript)");
;
;
async function middleware(request) {
    ...
    if (isAuthPage) {
        if (sessionToken) {
            ...
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$auth$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["findUserBySessionToken"])(sessionToken);
            if (user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cee7b85a._.js.map