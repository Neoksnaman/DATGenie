...
;
const alphanumericWithSpaces = (name, length)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().max(length, `${name} must be ${length} characters or less.`).regex(/^[a-zA-Z0-9\s]*$/, `${name} must be alphanumeric.`).min(1, `${name} is required.`);
const TaxProfileSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    ...
    companyName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().max(50, 'Company name must be 50 characters or less.').optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].literal('')),
    lastName: alphanumericWithSpaces('Last Name', 30).optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].literal('')),
    firstName: alphanumericWithSpaces('First Name', 30).optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].literal('')),
    middleName: alphanumericWithSpaces('Middle Name', 30).optional().or(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].literal('')),
    tradeName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().max(50, 'Trade name must be 50 characters or less.').min(1, 'Trade Name is required.'),
    subStreet: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(1, 'Sub/Street is required.'),
    street: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(1, 'Street is required.'),
    barangay: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(1, 'Barangay is required.'),
    cityMunicipality: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(1, 'City/Municipality is required.'),
    province: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(1, 'Province is required.'),
    zipCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(1, 'Zip Code is required.')
}).refine((data)=>{
...
async function getAllHeaderDataFromSheet(databaseId) {
    try {
        ...
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$schemas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TaxProfileSchema"]).safeParse(objects);
        if (result.success) {
            return result.data;
        } else {
            console.error("Validation errors encountered. Returning only valid profiles.");
            // The parse operation failed on the whole array, so we try row by row to salvage valid ones.
            // This is a fallback and shouldn't be the primary path.
            const validProfiles = [];
            objects.forEach((obj, index)=>{
                const singleResult = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$schemas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TaxProfileSchema"].safeParse(obj);
                if (singleResult.success) {
                    validProfiles.push(singleResult.data);
                } else {
                    console.error(`Skipping invalid row ${index + 2} in sheet ${databaseId}:`, singleResult.error.flatten().fieldErrors);
                }
            });
...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"40098fdfbbb36170895d26f1c11d82363ee9a1b214":"signUpUser","40684f4520a7c51a570d419ba1c98670ab6ba52b14":"loginUser","40b2e571cd0cb75ab827e90db3316b90dd461882f2":"getUserHeaderData","40eadca5c4f32c710e73aff0bf3f9fa61fc3c2f4cb":"analyzeExcelFile","6043bcb009bc6aa9b83327467834f75494fa1f00b7":"addTaxProfile","60c03a02cedce74d6fc9664d1879a50f2ea48706fa":"updateTaxProfile"},"",""] */ __turbopack_context__.s({
...
async function addTaxProfile(profileData, databaseId) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["appendHeaderDataToSheet"])(validatedData, databaseId);
        return {
            success: true,
            error: null
        };
...
async function updateTaxProfile(profileData, databaseId) {
    try {
        const validatedData = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$schemas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TaxProfileSchema"].parse(profileData);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$googlesheets$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateHeaderDataInSheet"])(validatedData, databaseId);
        return {
            success: true,
            error: null
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__656808aa._.js.map