...
const SessionsProvider = ({ children })=>{
    ...
    const fetchSessions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SessionsProvider.useCallback[fetchSessions]": async (isManualRefresh = false)=>{
            if (isLoading) return;
            if (!isManualRefresh && initialFetchComplete.current) return;
            startTransition({
                "SessionsProvider.useCallback[fetchSessions]": async ()=>{
                    // A session token must exist to fetch sessions.
                    if (!document.cookie.includes('sessionToken=')) {
                        // Silently return if no token, as this can happen during logout/login transitions.
                        return;
                    }
                    ...
                    if (result.success && result.sessions && result.currentSessionToken) {
                        ...
                        // Silently fail on first load if user is not logged in
                        if (initialFetchComplete.current || isManualRefresh) {
                            toast({
                                title: 'Error',
    ...
    const logoutLocalSession = (token)=>{
        setSessions((prev)=>prev.filter((s)=>s.token !== token));
    };
    const logoutAllOtherLocalSessions = ()=>{
...
_s(SessionsProvider, "oBvIjyA5SRF+z+ZJWVozq7qlvf4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"]
    ];
...
function AppLayoutContent({ children }) {
    ...
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const [isPending, startTransition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"])();
    const { refresh: pageSpecificRefresh } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$refresh$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRefresh"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppLayoutContent.useEffect": ()=>{
            // This effect runs once on initial client-side load.
            // It triggers the initial data fetch for all major data types.
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                const sessionTokenExists = document.cookie.includes('sessionToken=');
                if (sessionTokenExists && !sessionsFetched) {
                    fetchSessions();
                }
            }
        // The dependency array should only include the fetch functions and their completion flags
        // to ensure this logic correctly re-evaluates if a provider is reset.
        }
    }["AppLayoutContent.useEffect"], [
        fetchProfiles,
        taxProfilesFetched,
    ...
    const handleRefresh = ()=>{
        startTransition(()=>{
            // Call all global refresh functions
            fetchProfiles(true);
            fetchFiles(true);
            fetchSessions(true);
            // Call any page-specific refresh function that might be registered
            if (pageSpecificRefresh) {
                pageSpecificRefresh(true);
            }
        });
    };
...
_s(AppLayoutContent, "UFWea3qVi6zDl7t5iVGpHLg2liM=", false, function() {
    return [
...
//# sourceMappingURL=src_b8e15152._.js.map