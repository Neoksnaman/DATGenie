...
"[project]/src/lib/actions.ts [app-client] (ecmascript)": (function(__turbopack_context__) {
        ...
        "TaxProfileProvider.useCallback[fetchProfiles]": (isManualRefresh = false)=>{
            ...
            startTransition({
                "TaxProfileProvider.useCallback[fetchProfiles]": async ()=>{
                    ...
                    if (databaseId) {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserHeaderData"])(databaseId);
        ...
        "DatFilesProvider.useCallback[fetchFiles]": async (isManualRefresh = false, isBackground = false)=>{
            const performFetch = {
                "DatFilesProvider.useCallback[fetchFiles].performFetch": async ()=>{
                    ...
                    if (folderId) {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatFiles"])(folderId);
                        if (result.success && result.files) {
                            ...
                            if (!localStorage.getItem('dat-file-page-token')) {
                                const tokenResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInitialPageToken"])();
        ...
        "DatFilesProvider.useEffect": ()=>{
            ...
            const pollForChanges = {
                "DatFilesProvider.useEffect.pollForChanges": async ()=>{
                    ...
                    try {
                        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkForDatFileChanges"])(trackedFolderIds.current, pageToken);
...
//# sourceMappingURL=src_01ff177a._.js.map