...
"[project]/src/lib/actions/data:fff0e7 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$data$3a$fff0e7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/actions/data:fff0e7 [app-client] (ecmascript) <text/javascript>");
        ...
        "VerifyContent.useEffect": ()=>{
            ...
            startTransition({
                "VerifyContent.useEffect": async ()=>{
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$data$3a$fff0e7__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["verifyUserAccount"])(token);
                    if (result.success) {
                        setStatus('success');
...
//# sourceMappingURL=src_e580a8ce._.js.map