...
export async function generate1601FQExcel(datFileContents: string[], fileNames: string[]): Promise<ExcelResult> {
    try {
        ...
        if (!hasSched1Data && !hasSched2Data && !hasSched3Data) {
            return { success: false, error: "No data found for any schedule in the selected files." };
        }
        ...
        if (hasSched2Data) {
            const ws2Data: (string | number | null)[][] = [
                ...
                [null, "NUMBER", null, null, null, null, "VALUE", null],
                ['(1)','(2)','(3)','(4)','(5)', '(6)','(7)','(8)'],
                ["------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------"],
            ];
            ...
            const grandTotalRow = [
                "Grand Total:", null, null, null, null, totalFringeBenefit, totalGrossedUp, totalTaxWithheld
            ];
        ...
        if (hasSched3Data) {
            const ws3Data: (string | number | null)[][] = [
                ...
                [],
                [],
                [null, null, null, null, null, null, null, '1ST MONTH OF THE QUARTER', '2ND MONTH OF THE QUARTER', '3RD MONTH OF THE QUARTER', 'TOTAL FOR THE QUARTER'],
                ['SEQ', 'TAXPAYER', 'CORPORATION', 'INDIVIDUAL', 'ATC', 'STATUS CODE', null, 'AMOUNT OF', 'AMOUNT OF', 'AMOUNT OF', 'TOTAL'],
                ['NO', 'IDENTIFICATION', '(Registered Name)', '(Last Name, First Name, Middle Name)', null, null, "NATURE OF PAYMENT", 'INCOME PAYMENT', 'INCOME PAYMENT', 'INCOME PAYMENT', 'INCOME PAYMENT'],
                [null, "NUMBER", null, null, null, null, null, null, null, null, null],
                ['(1)','(2)','(3)','(4)','(5)', '(6)', null,'(7)','(8)','(9)', '(10)'],
                ["------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------", "------------------------------"],
            ];
            
            const allPayeeRowsSched3: any[][] = [];
